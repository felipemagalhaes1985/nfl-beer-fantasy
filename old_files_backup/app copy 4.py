...
class Participante(UserMixin, db.Model):
    ...
    # Relações
    # ADICIONADO cascade="all, delete-orphan" para garantir exclusão em cascata
...
# --- NOVAS Rotas de Gerenciamento de Participantes ---
...
# --- Outras Rotas placeholder (ainda não implementadas - algumas já estavam e foram mantidas) ---
